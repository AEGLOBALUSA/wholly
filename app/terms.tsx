  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
      <Head>
        ...
        <meta name="description" content="WHOLLY Terms of Service. Understand the rules and commitments for using our platform." />
        <meta property="og:title" content="Terms of Service — WHOLLY" />
        <meta property="og:url" content="https://whollydate.com/terms" />
      </Head>
